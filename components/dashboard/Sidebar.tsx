...
const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`border bg-yellow-50 rounded-md cursor-pointer mt-14 mb-9 ${isOpen ? "p-4 w-full h-[136px]" : "p-2 w-full h-[80px]"}`}>
        <div className="flex items-center">
          <Image className="ml-4" src={message} alt="message" />
          {isOpen && (
            <div className="ml-4">
              <p className="font-bold">Messages</p>
              <button className="bg-yellow-400 flex items-center justify-center rounded-md h-[32px] mt-2 mb-2 w-full">
      ...
      <div className="flex items-center gap-2 mt-16 bg-gray-50 rounded-md cursor-pointer p-2">
